...
### v0.3 content-QA pilot の追加ルール

5セットの評価では、**2026本試だけに似ているかではなく、本試・追試の両方から抽出した共有能力構造に合っているか**を判定する。特に、2026追試で目立つ「日時・経路・運行条件・地図/図・注意事項を使った実際的判断」も、必要に応じて命題レパートリーに含める。ただし自動運転・自治体交通の換皮は禁止する。
